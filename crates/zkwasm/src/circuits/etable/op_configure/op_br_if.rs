...
pub struct BrIfConfig<F: PrimeField> {
...
impl<F: PrimeField> EventTableOpcodeConfigBuilder<F> for BrIfConfigBuilder {
    fn configure(
...
impl<F: PrimeField> EventTableOpcodeConfig<F> for BrIfConfig<F> {
