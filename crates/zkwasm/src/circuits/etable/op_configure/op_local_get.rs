...
pub struct LocalGetConfig<F: PrimeField> {
...
impl<F: PrimeField> EventTableOpcodeConfigBuilder<F> for LocalGetConfigBuilder {
    fn configure(
...
impl<F: PrimeField> EventTableOpcodeConfig<F> for LocalGetConfig<F> {
