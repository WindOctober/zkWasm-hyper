...
pub struct GlobalGetConfig<F: PrimeField> {
...
impl<F: PrimeField> EventTableOpcodeConfigBuilder<F> for GlobalGetConfigBuilder {
    fn configure(
...
impl<F: PrimeField> EventTableOpcodeConfig<F> for GlobalGetConfig<F> {
