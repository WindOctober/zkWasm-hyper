...
pub struct MemoryGrowConfig<F: PrimeField> {
...
impl<F: PrimeField> EventTableOpcodeConfigBuilder<F> for MemoryGrowConfigBuilder {
    fn configure(
...
impl<F: PrimeField> EventTableOpcodeConfig<F> for MemoryGrowConfig<F> {
